    ...
    def import_from_csv(self, filename) -> None:
        ...
        with open(filename) as csv_file:
            ...
            for record in records:
                record_count+=1
                record['parsed-tags'] = [l.strip() for l in record['Tags'].split(",")]
...
class MealPlan:
    ...
    def generate_mealplan(self, num_weeks: int) -> None:
        ...
        for _ in range(num_weeks):
            ...
            day_constraints = [lambda r: "Vegetarisch" in r['parsed-tags'] and "Zondigen" not in r['parsed-tags'],
                            lambda r: "Vis" in r['parsed-tags'] and "Zondigen" not in r['parsed-tags'],
                            lambda r: "Asian" in r['parsed-tags']  and "Zondigen" not in r['parsed-tags'],
                            lambda r: "Steak" in r['parsed-tags']  and "Zondigen" not in r['parsed-tags'],
                            lambda r: "Pasta" in r['parsed-tags']  and "Zondigen" not in r['parsed-tags'],
                            lambda r: "Zondigen" not in r['parsed-tags']
                            ]
            random.shuffle(day_constraints)
            day_constraints.insert(4, lambda r: "Zondigen" in r['parsed-tags'])
